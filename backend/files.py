...
class FileRouter:
    ...
    async def insert_file_to_db(self, session: AsyncSession, user: User, file: Files) -> FileRefrence:
        session.add(file)
        await session.flush()
    ...
    def get_router(self) -> APIRouter:
        ...
        async def upload_new_file(
            ...
            try:
                ...
                async with aiofiles.open(join(FILE_PATH_PREFIX, str(file_refrence.file_id)), 'wb') as f:
